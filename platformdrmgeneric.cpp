...
uint32_t DrmGenericImporter::GetFormatForFrameBuffer(uint32_t fourcc_format,
                                                     uint32_t plane_type) {
